...
from apps.v1_admin.entities import CreateCodeSchema, CreateCodeParser
from apps.v1_admin.logics import create_sms_code, create_sms_code_task
...
async def create_code(parser: CreateCodeParser, background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(create_sms_code_task, params=params)
