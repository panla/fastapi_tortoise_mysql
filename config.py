...
TEST_DB_USER = config('TEST_DB_USER', default='root')
TEST_DB_PASSWD = config('TEST_DB_PASSWD')
TEST_DB_HOST = config('TEST_DB_HOST', default='127.0.0.1')
TEST_DB_PORT = config('TEST_DB_PORT', cast=int, default=3306)
TEST_DB_DATABASE = config('TEST_DB_DATABASE')
TEST_DB_MAX_SIZE = config('TEST_DB_MAX_SIZE', cast=int, default=2)
